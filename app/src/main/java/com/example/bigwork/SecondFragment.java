...
public class SecondFragment extends Fragment implements Runnable{
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        second_text.setMovementMethod(ScrollingMovementMethod.getInstance());
    ...
    public void run() {
        ...
        try {
            ...
            Elements divs = doc.getElementsByClass("blk122");
            ...
            for (int i = 0;i < as.size();i++) {
                ...
                itemList.add(new Item(str,all_temp,2));
