...
public class ThirdFragment extends Fragment implements Runnable{
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        third_text.setMovementMethod(ScrollingMovementMethod.getInstance());
    ...
    public void run() {
        ...
        try {
            ...
            Elements lis = doc.getElementsByClass("ty-card-type10-makeup");
            ...
            for (int i = 0;i < as.size();i++) {
                ...
                Document doc_temp = Jsoup.connect("http:" + val).get();
                ...
                itemList.add(new Item(str,all_temp,3));
            ...
            String url_new = "http:" + as.get(0).attr("href");
